...
const PropertyList = () => {
  ...
  return (
    <div className="flex justify-center">
      <div>
        <div className="max-w-6xl mx-auto px-4 flex justify-center flex-col   mt-5">
          <div className="flex justify-between items-center mb-5">
            <h1 className="text-xl sm:2xl font-bold ">Property Listings</h1>
            {isAdminDashboard && (
              <button
                onClick={() => setShowAddPropertyForm(true)}
                className="bg-gray-500 text-white px-4 py-2 text-sm sm:text:md rounded-md hover:bg-gray-800 focus:outline-none focus:bg-gray-800"
              >
                Add Property
              </button>
            )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 sm:col-1 w-100  lg:grid-cols-3 gap-4 mt-8">
            {properties.length === 0 ? (
              ...
              properties
                ...
                .map((property) => {
                  ...
                  return (
                    <div
                      key={property._id}
                      className="bg-white shadow-lg p-4 w-[360px] relative border sm:w-[400px] md:w-[360px] lg:w-[350px] border-gray-200"
                    >
                      {isAdminDashboard && (
